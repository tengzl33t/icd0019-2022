...
public class InstallmentGeneratorTest {
    ...
    public void isSumIsLargeEnoughThenGeneratesInstallmentsForWholePeriod() {
        String actual = generateInstallments(90, "2020-04-04", "2020-06-07");
        String expected = "[30, 2020-04-04], [30, 2020-05-01], [30, 2020-06-01]";
    ...
    public void whenPeriodIsTooLongThereAreNoZeroSumPayments() {
        String actual = generateInstallments(6, "2020-04-04", "2020-06-07");
        String expected = "[3, 2020-04-04], [3, 2020-05-01]";
    ...
    public void remainderIsDividedBetweenLastInstallments() {
        String actual = generateInstallments(11, "2020-04-04", "2020-06-07");
        String expected = "[3, 2020-04-04], [4, 2020-05-01], [4, 2020-06-01]";
    ...
    public void amountIsLessThanMinimumGivesJustOneInstallment() {
        String actual = generateInstallments(2, "2020-04-04", "2020-06-07");
        String expected = "[2, 2020-04-04]";
